...
For example, to conduct a simple Conditional Autogressive Model (BYM) on Atlantic cod, one needs but specify the run parameters for "carstm" to the selection criteria. 
