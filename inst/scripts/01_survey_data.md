...
If you are wanting to re-compute net swept areas (due to new data, currently the Groudfish program is not recording/saving net mensuration data), then you can review the following and then adjust to your needs:

```r
# ----------------------------------------
redo_historical_netmensuration_estimates
...
Prepare snowcrab data for assimilation by running:

[01_snowcrab_data.md](https://github.com/jae0/bio.snowcrab/tree/master/inst/markdown/01_snowcrab_data.md)     
...
# todo .. incomplete (e.g salinity, O2, pH, etc)
